...
namespace DGIIFacturadorLoginMVCApp.Controllers
{
    ...
    {
        private readonly IDgiiConfigService _configService;
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _env;
        private const string passCert = "LD271167";

        public FacturacionDGIIController(IDgiiConfigService configService, ApplicationDbContext context, IWebHostEnvironment env)
        {
        ...
        private string urlBase => _configService.GetBaseUrl();
        public string urlSemilla => $"{urlBase}/autenticacion/api/Autenticacion/Semilla";
        public string urlValidarSemilla => $"{urlBase}/autenticacion/api/Autenticacion/ValidarSemilla";
        public string urlRecepcionFactura => $"{urlBase}/recepcion/api/FacturasElectronicas";
        public string urlRecepcionResumenFactura => $"{urlBase}/recepcionfc/api/recepcion/ecf";
        public string urlConsultaFactura => $"{urlBase}/consultaresultado/api/Consultas/Estado";
        public string urlRecepcionFacturaAprobacionComercial => $"{urlBase}/AprobacionComercial/api/AprobacionComercial";
        public string urlConsultaTimbre => $"{urlBase}/ConsultaTimbre";
        public string urlConsultaTimbreResumenFactura => $"{urlBase}/ConsultaTimbreFc";
        ...
        public IActionResult GenerarPDF(int id, string codigoSeguridad)
        {
            ...
            string url = $"{urlConsultaTimbre}?RncEmisor={factura.RNCEmisor}&RncComprador={factura.RNCComprador}&ENCF={factura.ENCF}&FechaEmision={factura.FechaEmision}&MontoTotal={factura.MontoTotal}&FechaFirma={fechaFirmaFormateada}&CodigoSeguridad={codigoSeguridad}";
        ...
        [HttpGet]
        public IActionResult GenerarPDFRFCE(int id, string codigoSeguridad)
        {
            var factura = _context.FacturasDGII
                    .Include(f => f.Items)
                    .FirstOrDefault(f => f.Id == id);
            ...
            string url = $"{urlConsultaTimbreResumenFactura}?RncEmisor={factura.RNCEmisor}&RncComprador={factura.RNCComprador}&ENCF={factura.ENCF}&FechaEmision={factura.FechaEmision}&MontoTotal={factura.MontoTotal}&FechaFirma={fechaFirmaFormateada}&CodigoSeguridad={codigoSeguridad}";
        ...
        public IActionResult ConfiguracionAmbiente()
        {
            ViewBag.AmbienteActual = _configService.Ambient;
            return View();
        }

        [HttpPost]
        public IActionResult ConfiguracionAmbiente(string nuevoAmbiente)
        {
            if (nuevoAmbiente == "certecf" || nuevoAmbiente == "testecf" || nuevoAmbiente == "ecf")
            {
                _configService.Ambient = nuevoAmbiente;
            }
        ...
        private byte[] CrearFacturaPDFInMemory(FacturasDGII factura, string codigoSeguridad, string webRootPath, string url)
        {
        ...
        public IActionResult comprobanteE320000000011ECF(FacturaDGIIModelE32 model)
        {
            ...
            try
            {
                ...
                if (respuesta.root == "ECF")
                {
                    ...
                    return View("verFacturaECF", respuesta);
                }
                else
                {
                    ViewBag.MensajeError = respuesta.Mensaje;
        ...
        [HttpGet]
        public IActionResult comprobanteE430000000008()
        {
            var model = new FacturaDGIIModel11
            {
                ECF = new ECFModel11
        ...
        [HttpPost]
        public IActionResult comprobanteE430000000008(FacturaDGIIModel11 model)
        {
            if (model?.ECF?.InformacionReferencia != null)
            {
                if (string.IsNullOrWhiteSpace(model.ECF.InformacionReferencia.NCFModificado))
        ...
        [HttpGet]
        public IActionResult comprobanteE440000000007()
        {
            var model = new FacturaDGIIModel12
            {
                ECF = new ECFModel12
        ...
        [HttpPost]
        public IActionResult comprobanteE440000000007(FacturaDGIIModel12 model)
        {
            if (model?.ECF?.InformacionReferencia != null)
            {
                if (string.IsNullOrWhiteSpace(model.ECF.InformacionReferencia.NCFModificado))
                    ...
                    DetallesItems = new DetallesItemsModel13
                    {
                        Item = new List<ItemModel13>
                        {
                            new ItemModel13
                            {
                                ...
                                NombreItem = "SERVICIO PUBLICIDAD",
                                IndicadorBienoServicio = "2",
                                DescripcionItem = "prestacion de servicios relacionados con la creacion, ejecucion y distribucion de campañas publicitarias.",
                                CantidadItem = "1.00",
                                UnidadMedida = "43",
        ...
        [HttpGet]
        public IActionResult comprobanteE450000000011()
        {
            var model = new FacturaDGIIModel13
            {
                ECF = new ECFModel13
        ...
        [HttpPost]
        public IActionResult comprobanteE450000000011(FacturaDGIIModel13 model)
        {
            if (model?.ECF?.InformacionReferencia != null)
            {
                if (string.IsNullOrWhiteSpace(model.ECF.InformacionReferencia.NCFModificado))
            ...
            if (model?.ECF?.Encabezado.OtraMoneda != null)
            {
                if (string.IsNullOrWhiteSpace(model.ECF.Encabezado.OtraMoneda.TipoMoneda))
                {
                    model.ECF.Encabezado.OtraMoneda = null;     
                }
            }
            ...
            if (model?.ECF?.DetallesItems?.Item != null)
            {
                foreach (var item in model.ECF.DetallesItems.Item)
                {
                    if (item.OtraMonedaDetalle != null &&
                        string.IsNullOrWhiteSpace(item.OtraMonedaDetalle.PrecioOtraMoneda))
                    {
        ...
        [HttpGet]
        public IActionResult comprobanteE460000000009()
        {
            var model = new FacturaDGIIModel14
            {
                ECF = new ECFModel14
        ...
        [HttpPost]
        public IActionResult comprobanteE460000000009(FacturaDGIIModel14 model)
        {
            if (model?.ECF.Encabezado.IdDoc.TablaFormasPago != null)
            {
                if (string.IsNullOrWhiteSpace(model.ECF.Encabezado.IdDoc.TablaFormasPago.FormaDePago?.FirstOrDefault()?.FormaPago))
                {
                    model.ECF.Encabezado.IdDoc.TablaFormasPago = null;
                }
            }
